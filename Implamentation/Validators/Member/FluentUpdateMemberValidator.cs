...
{
    public class FluentUpdateMemberValidator : AbstractValidator<MemberDto>
    {
        private readonly ProjectContext _context;

        public FluentUpdateMemberValidator(ProjectContext context)
        {
            _context = context;
        ...
        {
            var names = _context.Members.IgnoreQueryFilters().Where(x => x.Id != dto.Id).Select(x => x.MemberCardNumber);
