...
{
    public class FluentCreateTitleValidator : AbstractValidator<CreateModifyTitle>
    {
        private readonly ProjectContext _context;

        public FluentCreateTitleValidator(ProjectContext context)
        {
            _context = context;
            ...
            RuleFor(x => x.Image)
                .NotNull()
                .WithMessage("File mustn't be empty")
                .DependentRules(() =>
                {
                    RuleFor(x => x.Image)
                        .Must(img =>
